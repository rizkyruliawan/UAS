...
<body id="page-top">
  ...
  ?>
         ...
         if(isset($_POST['simpan'])){
            ...
            $db->query("INSERT INTO daftarbantuan(jenis_alokasi,jumlah_dana,nama_lengkap,no_hp,email) VALUES
            ('$_POST[alokasi]','$_POST[jumlah]','$_POST[nama]','$_POST[nohp]','$_POST[email]')");
            echo "<div class='alert alert-info'>Data Tersimpan</div>";
            echo "<meta http-equiv='refresh' content='1;url=tampildata.php?halaman=menu'>";
         }
